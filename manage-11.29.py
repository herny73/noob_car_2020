...
def drive(cfg, model_path=None, model_path_1=None, use_joystick=False, model_type=None, camera_type='single', meta=[] ):
    ...
    if model_path_1:
        ...
        if '.h5' in model_path_1:
            ...
            load_weights(kl, weights_path_1)
    ...
    class MySwitch:
        ...
        def __init__(self):
            self.pilot_state = False  #by zmx 2020.10.24 到时候会改成int型
            self.mode = 0

        def run(self,mod_switch):
            if (mod_switch):
                print("detected")
                self.pilot_state = ~self.pilot_state
    ...
    V.add(MyPilot(), inputs=['mypilot_mod'], outputs=['mypilot/angle','mypilot/throttle'])
...
if __name__ == '__main__':
    ...
    if args['drive']:
        ...
        drive(cfg, model_path=args['--model'],
              ...
              use_joystick=args['--js'], model_type=model_type, camera_type=camera_type,
            meta=args['--meta'])
